import br.com.joaomiguelg.dao.ClienteSetDAO;
...
public class Main {
    ...
    private static void atualizar(String dados) {
        ...
        Cliente cliente = new Cliente(dadosSeparados[0],parseLong(dadosSeparados[1]),parseLong(dadosSeparados[2]),dadosSeparados[3],parseInt(dadosSeparados[4]),dadosSeparados[5],dadosSeparados[6]);
        iClienteDAO.alterar(cliente);
    }

    private static void excluir(String dados) {
        iClienteDAO.excluir(parseLong(dados));
        JOptionPane.showMessageDialog(null, "Cliente excluído com sucesso: ", "Sucesso",JOptionPane.INFORMATION_MESSAGE);
    }


    private static void consultar(String dados) {
        Cliente cliente = iClienteDAO.consultar(parseLong(dados));
        if (cliente != null) {
